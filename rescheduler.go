...
var (
	...
	deleteNonReplicatedPods = flags.Bool("delete-non-replicated-pods", false, `Delete non-replicated pods in on-demand instance. Note that some non-replicated pods will not be rescheduled.`)
)
